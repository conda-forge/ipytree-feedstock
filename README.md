...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ipytree-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6445&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ipytree-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ipytree` can be installed with:

```
conda install ipytree
```

It is possible to list all of the versions of `ipytree` available on your platform with:
